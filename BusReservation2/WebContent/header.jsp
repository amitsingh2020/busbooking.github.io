...
<li><a title="View your ticket" href="ViewTicket.jsp" target="ifr"><button class="btn">View_Ticket</button></a></li>
<li><a title="help" href="help/mainhelp.jsp" target="ifr"><button class="btn">Help</button></a></li>
